			...
			<div  class="row" style="display: flex; gap: 8px; margin-top: 5px;">
				...
				<div  class="col-md-4" style="display: flex; gap: 20px;">
					...
					<div class="radio-container">
						...
						<ul class="radio">
							<li>
								<input type="radio" id="option-necklace-yes" name="necklace" checked value="1" {{ isset($pet) && $pet->necklace == '1' ? 'checked' : '' }}>
			...
			<div  class="row" style="display: flex; gap: 8px; margin-top: 5px;">
				...
				<div  class="col-md-4" style="display: flex; gap: 20px;">
					...
					<div class="radio-container">
						...
						<ul class="radio">
							<li>
								<input type="radio" id="option-allergy-yes" name="allergy" checked value="1" {{ isset($pet) && $pet->allergy == '1' ? 'checked' : '' }}>
			...
			<div  class="row" style="display: flex; gap: 8px; margin-top: 15px;">
				...
				<div  class="col-md-4" style="display: flex; gap: 20px;">
					...
					<div class="radio-container">
						...
						<ul class="radio">
							<li>
								<input type="radio" id="option-fracture-yes" name="fracture"  checked value="1" {{ isset($pet) && $pet->fracture == '1' ? 'checked' : '' }}>
			...
			<div  class="row" style="display: flex; gap: 8px; margin-top: 15px;">
				...
				<div  class="col-md-4" style="display: flex; gap: 20px;">
					...
					<div class="radio-container">
						...
						<ul class="radio">
							<li>
								<input type="radio" id="option-scar-yes" name="scar" checked value="1" {{ isset($pet) && $pet->scar == '1' ? 'checked' : '' }}>
			...
			<div  class="row" style="display: flex; gap: 8px; margin-top: 15px;">
				...
				<div  class="col-md-4" style="display: flex; gap: 20px;">
					...
					<div class="radio-container">
						...
						<ul class="radio">
							<li>
								<input type="radio" id="option-hospitalization-yes" name="hospitalization" checked value="1" {{ isset($pet) && $pet->hospitalization == '1' ? 'checked' : '' }}>
			...
			<div class="row" style="display: flex; gap: 8px; margin-top: 15px;">
				<div class="col-md-4">
					<div class="radio-container">
						...
						<ul class="radio">
							<li>
								<input type="radio" id="option-training-yes" name="training" checked value="1" {{ isset($pet) && $pet->training == '1' ? 'checked' : '' }}>
