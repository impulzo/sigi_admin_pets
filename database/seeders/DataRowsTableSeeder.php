    ...
    public function run()
    {
        ...
        \DB::table('data_rows')->insert(array (
            ...
            array (
                ...
                'add' => 1,
                'delete' => 1,
                'details' => '{"validation":{"rule":"required|date|after_or_equal:today|before_or_equal:+1 year","messages":{"max":"El campo :attribute debe ser igual o mayor de la fecha actual :max."}}}',
                'order' => 4,
            ),
            194 => 
            array (
